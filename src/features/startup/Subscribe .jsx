...
const Subscribe = () => {
  return (
    <Flex minH={'70vh'} align={'center'} justify={'center'} py={12}>
...
const NotificationIcon = createIcon({
  ...
  path: (
    <g id="Notification">
      ...
      <path className="cls-4" fill={'#7ece67'} d="M105,108A22,22,0,0,1,83.09,84a22,22,0,0,0,43.82,0A22,22,0,0,1,105,108Z" />
      ...
      />
      <path className="cls-3" fill={'#f6b756'} d="M46.09,86.73,3,127H1v-1c6-5.62-1.26,1.17,43.7-40.78A1,1,0,0,1,46.09,86.73Z" />
      <path
        className="cls-3"
        fill={'#f6b756'}
