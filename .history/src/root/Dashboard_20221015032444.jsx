    ...
    <div className="dashboard">
      ...
      <Routes>
        ...
        <Route path="workspace" element={<WorkSpace />}>
          <Route path="workspace/workspace-data-fill-form" element={<WorkspaceDataFillForm />} />
          <Route path="workspace/content-ui-tools" element={<ContentUITools />} />
          <Route path="workspace/content-dashboard" element={<ContentDashboard />} />
          <Route path="workspace/content-taskbar" element={<ContentTaskbar />} />
          <Route path="workspace/content-leaderboard" element={<ContentLeaderBoard />} />
          <Route path="workspace/content-random-code" element={<ContentRandomCode />} />
          <Route path="workspace/content-arena" element={<ContentArena />} />
        ...
        {/* SUPPORT *}        <Route path="communityguidlines" element={<CommunityGuidlines />} />        <Route path="helpcenter" element={<HelpCenter />} />
