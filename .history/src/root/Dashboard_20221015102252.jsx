      ...
      <Routes>
        ...
        <Route path="/" element={<StartUp />} />
          ...
          <Route path="workspace" element={<WorkSpace />}>
            <Route path="workspace-data-fill-form" element={<WorkSpace />} />
            <Route path="content-ui-tools" element={<WorkSpace />} />
            <Route path="content-dashboard" element={<WorkSpace />} />
            <Route path="content-projects" element={<WorkSpace />} />
            <Route path="content-projects/:projectId" element={<WorkSpace />} />
