...
const Content = ({ ref, handleWorkspaceComponentClick }) => {
  ...
  return (
    <div className={`${styles.user_profile}`}>
      <div
        className={`${
          !navLight ? styles.navigation_main_container_transparent : styles.navigation_main_container_light
        }`}
      >
        ...
        <div className={`${styles.user_profile_body_top}`}>
          ...
          <div className={`${styles.features_workspace_arena}`}>
            ...
            <button
              ...
              onClick={() => dynamicRouting(navigate,`/workspace/workspace-data-fill-form")}
            >
              {' '}
              Complete setup
            </button>
