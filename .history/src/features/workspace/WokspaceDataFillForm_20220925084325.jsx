...
const WorkspaceDataFillForm = ({ ref, setUrl }) => {
        ...
        <div>
          ...
          <div className={`${styles.wrkspc_form_right_side}`}>
            <div className={`${styles.right_form_header}`}>
              <p>
                Additional information about you is important for us to fairly select your competitors and set
                difficulty algorithms that match your experience
              </p>
            </div>
