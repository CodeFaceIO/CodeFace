...
const ContentUITools = () => {
  ...
  const [selectedFileCodePreviewProps, setSelectedFileCodePreviewProps] =
    React.useState('');
  const [selectedFileCodePreviewImports, setSelectedFileCodePreviewImports] =
    React.useState([
      {
        name: 'React',
        path: 'react',
  ...
  const [codePreviewImportsString, setCodePreviewImportsString] =
    React.useState('');
  ...
  const [codePreviewComponentProps, setCodePreviewComponentProps] =
    React.useState('');
  const [codePreviewComponentImports, setCodePreviewComponentImports] =
    React.useState([
      {
        name: 'React',
        path: 'react',
