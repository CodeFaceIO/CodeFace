<<<<<<< Updated upstream:.history/src/features/workspace/ContentArena_20221122185824.jsx
...
const ContentArena = ({ ref, handleThemeChange }) => {
  ...
  const renderedSideMenus = sideMenus.map((Icon, index) => {
    return (
      <div className={styles.arena_work_workspace_nav_icon} key={index} onClick={
        () => setSideBar(!sideBar)
      }>
        <Icon />
      </div>
...
=======
>>>>>>> Stashed changes:.history/src/features/workspace/ContentArena_20221016050034.jsx
