...
import { uploadcare } from 'file-loader';

const widget = uploadcare.Widget('#uploader', { publicKey: process.env.UPLOADCARE_PUBLIC_KEY }, { multiple: true });
    ...
    <div>
      ...
      <div className={`${styles.random_code_container_board}`}>
        <div>
          ...
          <input
            type="hidden"
            aria-roledescription="uploadcare-uploader"
            data-public-key=""
